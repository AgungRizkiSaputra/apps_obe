...
void main() async {
  ...
  // Konfigurasi Inisialisasi Supabase Pusat milik Agung (UTUH 100% TIDAK DIUBAH)
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // Splash screen dipasang sebagai gerbang utama dengan const agar RAM super enteng
